"""
Django settings for lucky_unit_dev_61880 project.
...
ROOT_URLCONF = 'lucky_unit_dev_61880.urls'
...
WSGI_APPLICATION = 'lucky_unit_dev_61880.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "lucky_unit_dev_61880 API",
    "DESCRIPTION": "API documentation for lucky_unit_dev_61880 App",
    "VERSION": "v1",
}
